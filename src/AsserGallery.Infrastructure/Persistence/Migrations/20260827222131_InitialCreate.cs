        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TargetIdOrUrl = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FacebookDestinations", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_FinancialTransactions_Products_LinkedProductId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ProductId = table.Column<int>(type: "int", nullable: false),
                    FacebookDestinationId = table.Column<int>(type: "int", nullable: false),
                    PostedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    PostContent = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    PostUrlOrId = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProductPosts_FacebookDestinations_FacebookDestinationId",
                        column: x => x.FacebookDestinationId,
                        principalTable: "FacebookDestinations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FinancialTransactions_LinkedProductId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductPosts_FacebookDestinationId",
                table: "ProductPosts",
                column: "FacebookDestinationId");
